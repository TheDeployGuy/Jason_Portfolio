            ...
            <div className="header-content">
                <div className="row">
                    <div className="col-md-offset-2 col-md-8">
                        ...
                        <p>My name is Jason, I have been working for 3+ years as an Automation Engineer. I am also an inspiring Full stack developer mainly specializing in the MEAN stack. 
                        </p> 
                        <p>Here you will find personal projects and client projects. If you think I would be a good fit for your project, Contact me!</p>
